...
import { BookOpen, Search, Shuffle, ChevronLeft, ChevronRight, Heart } from 'lucide-react'
import './App.css'
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 w-64 bg-white border border-stone-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-300"
                  value={searchTerm}
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <button
                      ...
                      className={`p-1 rounded ${favorites.includes(chapter.chapter_number) ? 'text-red-500' : 'text-stone-400 hover:text-red-500'}`}
                    >
                      <Heart className={`w-4 h-4 ${favorites.includes(chapter.chapter_number) ? 'fill-current' : ''}`} />
                    </button>
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white rounded-lg border border-stone-200 hover:bg-stone-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className={`p-2 rounded-lg ${favorites.includes(currentChapter) ? 'text-red-500 bg-red-50' : 'text-stone-400 hover:text-red-500 hover:bg-red-50'} transition-colors`}
                    >
                      <Heart className={`w-5 h-5 ${favorites.includes(currentChapter) ? 'fill-current' : ''}`} />
                    </button>
                  </div>
                </div>
                </div>
            ...
            <div className="mt-8 flex justify-center">
              <div className="flex items-center gap-2 bg-white rounded-lg p-2 border border-stone-200">
                {[...Array(Math.min(9, 81))].map((_, i) => {
                  const chapterNum = Math.max(1, Math.min(81, currentChapter - 4 + i))
                  return (
                    <button
                      key={chapterNum}
